...
public class Town
{
    ...
    public void setCheatMode(boolean set) {
        cheatMode = set;
    }

    public void setEasyMode(boolean set) {
        easyMode = set;
    }
    ...
    public void lookForTrouble()
    {
        ...
        else
        {
            ...
            if (cheatMode) {
                ...
                goldDiff *= 2;
                if (Math.random() > (noTroubleChance/4))
                {
                    printMessage += "Okay, stranger! You proved yer mettle. Here, take my gold.";
                ...
                else
                {
                    if (hunter.getGold() - goldDiff <= 0) {
                        ...
                        printMessage += "\nYou lost the brawl and pay " +  goldDiff/2 + " gold.";
                        hunter.changeGold(-1 * goldDiff/2);
                    }
                }
            }
